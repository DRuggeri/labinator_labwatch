module github.com/DRuggeri/labwatch/reliability-test

go 1.24.1

require (
	github.com/DRuggeri/labwatch v0.0.0-00010101000000-000000000000
...
require (
	...
	github.com/siderolabs/talos/pkg/machinery v1.9.1 // indirect
...
replace github.com/DRuggeri/labwatch => ../
